...
const collections = [
  ...
  },
  {
    ...
    count: "1025",
    images: ["/images/Mushroom.png", "/images/small-mushroom.png", "/images/sm-mashroom.png"],
  },
  {
    ...
    count: "1025",
    images: ["/images/disco.png", "/images/disco-man.png", "/images/disco-man-sm.png"],
  },
];
...
export default function TrendingCollection() {
  return (
    <SectionWrapper className="bg-[#2B2B2B] text-white">
      ...
      <p className="text-grayText mb-20">Checkout our weekly updated trending collection.</p>
