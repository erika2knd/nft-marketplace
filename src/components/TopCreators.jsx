  ...
  return (
    <SectionWrapper className="bg-[#2B2B2B] text-white">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          ...
          <Link href="/rankings" className="border-2 border-[#A259FF] rounded-[15px] px-12 py-4 flex items-center gap-5 transition-transform duration-300 ease-in-out hover:scale-95">
