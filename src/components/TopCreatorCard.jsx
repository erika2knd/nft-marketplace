export default function TopCreatorCard({ index, name, avatar, sales }) {
  return (
    <div className="w-full flex justify-center">
      <div className="relative bg-[#3B3E47] p-6 rounded-[20px] flex flex-col items-center text-center w-full max-w-[240px] transition-transform duration-300 ease-in-out hover:scale-95">
