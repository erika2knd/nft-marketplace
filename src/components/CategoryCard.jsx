export default function CategoryCard({ title, image, icon }) {
  return (
    <div className="w-full max-w-[240px] mx-auto rounded-[20px] overflow-hidden bg-[#3B3E47] h-[316px] relative group transition-transform duration-300 ease-in-out hover:scale-95">
