export default function CategoryCard({ title, image, icon }) {
  return (
    <div className="rounded-[20px] overflow-hidden bg-[#3B3E47] w-[240px] h-[316px] relative group transition-transform duration-300 ease-in-out hover:scale-95">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[80%] z-10">
        <img src={icon} alt={title} className="w-25 h-25" />
      </div>
