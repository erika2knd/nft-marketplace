  ...
  <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
    ...
    <div className="w-full lg:w-auto flex-1">
      ...
      <div className="flex flex-col sm:flex-row lg:hidden gap-4 mb-6 justify-center">
        ...
        <button className="border border-[#A259FF] text-white px-6 py-3 rounded-[20px] flex items-center justify-center gap-2 transition-transform hover:scale-95">
      ...
      <div className="mb-6 text-left">
        ...
        <p className="text-white">The Internet’s Friendliest Designer Kid.</p>
      </div>
