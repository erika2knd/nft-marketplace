    ...
    <SectionWrapper className="bg-[#2B2B2B] text-white">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-12 text-[#858584] text-sm border border-[#3B3B3B] rounded-[20px] px-7 py-4 mb-4">
          ...
          <span className="col-span-2 text-center">NFTs Sold</span>
        ...
        <div className="space-y-4">
          {creatorsData.map((creator, index) => (
            ...
            >
              ...
              <p className="col-span-2 text-green-400 text-center">{creator.change}</p>

              <p className="col-span-2 text-white text-center">{creator.nftsSold}</p>

              <p className="col-span-2 text-white text-right font-mono">{creator.volume}</p>
            </div>
          ))}
        </div>
      </div>
